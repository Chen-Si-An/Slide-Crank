...
BEGIN_MESSAGE_MAP(CSlideCrank1App, CWinApp)
...
CSlideCrank1App::CSlideCrank1App()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CSlideCrank1App 物件

CSlideCrank1App theApp;


// CSlideCrank1App 初始設定

BOOL CSlideCrank1App::InitInstance()
{
